...
//		System.out.println(Md5Crypt.md5Crypt(keyBytes, salt, prefix));
		
//		System.out.println(DatatypeConverter.printHexBinary(getEncryptedPassword("123456", "QAZWDXED".getBytes())).toLowerCase());
	}
