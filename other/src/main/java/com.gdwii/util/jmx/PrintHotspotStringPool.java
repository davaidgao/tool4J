...
public class PrintHotspotStringPool extends Tool {
	@Override
    public void run() {
	...
	public static void main(String[] args) {
		new PrintHotspotStringPool().execute(new String[] { "pid"});
	}
}
